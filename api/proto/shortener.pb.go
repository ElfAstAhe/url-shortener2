...
const file_proto_shortener_proto_rawDesc = "" +
	"\n" +
	"\x15proto/shortener.proto\x12\x0eurls.shortener\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x03url\x18\x01 \x03(\v2\x17.urls.shortener.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\x83\x02\n" +
	"\x10ShortenerService\x12S\n" +
	"\n" +
	"ShortenURL\x12!.urls.shortener.URLShortenRequest\x1a\".urls.shortener.URLShortenResponse\x12P\n" +
	"\tExpandURL\x12 .urls.shortener.URLExpandRequest\x1a!.urls.shortener.URLExpandResponse\x12H\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a .urls.shortener.UserURLsResponseB\x1aZ\x18shortener/grpc/shortenerb\x06proto3"

var file_proto_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: urls.shortener.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: urls.shortener.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: urls.shortener.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: urls.shortener.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: urls.shortener.UserURLsResponse
	(*URLData)(nil),            // 5: urls.shortener.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_proto_shortener_proto_depIdxs = []int32{
	5, // 0: urls.shortener.UserURLsResponse.url:type_name -> urls.shortener.URLData
	0, // 1: urls.shortener.ShortenerService.ShortenURL:input_type -> urls.shortener.URLShortenRequest
	2, // 2: urls.shortener.ShortenerService.ExpandURL:input_type -> urls.shortener.URLExpandRequest
	6, // 3: urls.shortener.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: urls.shortener.ShortenerService.ShortenURL:output_type -> urls.shortener.URLShortenResponse
	3, // 5: urls.shortener.ShortenerService.ExpandURL:output_type -> urls.shortener.URLExpandResponse
	4, // 6: urls.shortener.ShortenerService.ListUserURLs:output_type -> urls.shortener.UserURLsResponse
